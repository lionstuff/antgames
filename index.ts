...
const getRandomInt = ( digits: number = 1 ): number => {
  Math.random();
...
class MapLocation /* extends OffscreenCanvas  */implements ILocationOptions {
...
// class World /* extends Array<MapLocation[]> */ {
class World {
  /**
   * @protected
   * @returns {MapLocation}
...
type UnitOptions = ILocationEffects & IUnitOptions;

class Unit implements UnitOptions {
  public armor: number;
